...
class LookForMissingAttributesDockWidget(QtWidgets.QDockWidget, FORM_CLASS):
    ...
    def setup(self):
        ...
        self.ui.txtNextBef.setText(str(valMax(',', 'bef_nr')))
        self.ui.txtNextFund.setText(str(valMax(',', 'fund_nr')))
        self.ui.txtNextProf.setText(str(valMax(',', 'prof_nr')))
        self.ui.txtNextProb.setText(str(valMax(',', 'prob_nr')))
    ...
    def go(self):
        ...
        if  iface.activeLayer().selectedFeatureCount() == 0:
            ...
            delimiter = self.txtDelimiter.text()
            numFailCol = self.numFail(delimiter, layer, fieldname)
    ...
    def numFail(self, delimiter, layer, fieldname):
        numCol = []
