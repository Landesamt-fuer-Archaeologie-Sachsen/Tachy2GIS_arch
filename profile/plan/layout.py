...
class Layout:
    ...
    def __createLayout(self, profilePath):
        ...
        # Init map item
        item_map = QgsLayoutItemMap(lyt)
        item_map.setRect(20, 20, 20, 20)
        ...
        item_map.setLayers([self.imageLayerProfil])  # set layers to be mapped
        ...
        item_map.setBackgroundColor(QColor(255, 150, 150, 0))

        print("layersToRender", item_map.layersToRender())
        lyt.addLayoutItem(item_map)
        ...
        item_map.attemptMove(QgsLayoutPoint(5, 20, QgsUnitTypes.LayoutMillimeters))
        item_map.attemptResize(QgsLayoutSize(180, 180, QgsUnitTypes.LayoutMillimeters))
